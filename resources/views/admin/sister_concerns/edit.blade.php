...
@section('title', 'Edit Sister Concern')
@section('page-title', 'Edit Sister Concern')

@section('content')
<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-3xl">
    <form action="{{ route('admin.sister_concerns.update', $item) }}" method="POST" enctype="multipart/form-data">
        @csrf @method('PUT')
        <div class="space-y-5">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Company Name</label>
                <input type="text" name="company_name" value="{{ old('company_name', $item->company_name) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('company_name') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="text" name="logo" value="{{ old('logo', $item->logo) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('logo') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="text" name="website_link" value="{{ old('website_link', $item->website_link) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('website_link') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="text" name="contact_phone" value="{{ old('contact_phone', $item->contact_phone) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('contact_phone') border-red-500 @enderror">
            ...
            <div>
                ...
                <input type="text" name="contact_email" value="{{ old('contact_email', $item->contact_email) }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('contact_email') border-red-500 @enderror">

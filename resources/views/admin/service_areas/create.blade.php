...
<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-3xl">
        <form action="{{ route('admin.service_areas.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="space-y-5">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="region" value="{{ old('region') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('region') border-red-500 @enderror">
            ...
            <div class="flex items-center gap-2 pt-1">
                ...
                <input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">

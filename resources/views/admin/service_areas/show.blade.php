...
@section('title', 'Service Area Details')
@section('page-title', 'Service Area Details')
...
<div class="bg-white rounded-xl border border-gray-200 p-6 max-w-3xl">
    ...
    <div class="flex items-center gap-3 pt-5 border-t border-gray-100 mt-6">
        <a href="{{ route('admin.service_areas.index') }}" class="px-6 py-2.5 text-gray-700 text-sm font-semibold rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors">

        ...
        <div class="space-y-5">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $blogPost->title ?? '') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('title') border-red-500 @enderror">
                    @error('title') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1.5">Slug</label>
                    <input type="text" name="slug" value="{{ old('slug', $blogPost->slug ?? '') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('slug') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="author" value="{{ old('author', $blogPost->author ?? '') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('author') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="number" name="reading_time" value="{{ old('reading_time', $blogPost->reading_time ?? '') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('reading_time') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="tags" value="{{ old('tags', $blogPost->tags ?? '') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('tags') border-red-500 @enderror">
                ...
                <div>
                    ...
                    @if($blogPost->featured_image) <p class="text-xs text-gray-500 mt-1">Current: {{ $blogPost->featured_image }}</p> @endif
                </div>
                <div>
                    ...
                    @if($blogPost->image) <p class="text-xs text-gray-500 mt-1">Current: {{ $blogPost->image }}</p> @endif
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1.5">Meta Title</label>
                    <input type="text" name="meta_title" value="{{ old('meta_title', $blogPost->meta_title ?? '') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('meta_title') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 pt-1">
                        ...
                        <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $blogPost->is_featured ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 pt-1">
                        ...
                        <input type="checkbox" name="status" value="1" {{ old('status', $blogPost->status ?? false) ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
            ...
            <div>
                ...
                <textarea name="excerpt" rows="3" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('excerpt') border-red-500 @enderror">{{ old('excerpt', $blogPost->excerpt ?? '') }}</textarea>
            ...
            <div>
                ...
                <textarea name="content" rows="15" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('content') border-red-500 @enderror">{{ old('content', $blogPost->content ?? '') }}</textarea>
                @error('content') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
            </div>
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Meta Description</label>
                <textarea name="meta_description" rows="3" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('meta_description') border-red-500 @enderror">{{ old('meta_description', $blogPost->meta_description ?? '') }}</textarea>

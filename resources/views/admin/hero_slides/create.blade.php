        ...
        <div class="space-y-5">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="badge_text" value="{{ old('badge_text') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('badge_text') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="button_text" value="{{ old('button_text') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('button_text') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="button_link" value="{{ old('button_link') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('button_link') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="button_text_2" value="{{ old('button_text_2') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('button_text_2') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="button_link_2" value="{{ old('button_link_2') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('button_link_2') border-red-500 @enderror">
                ...
                <div>
                    ...
                    <input type="text" name="video" value="{{ old('video') }}" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('video') border-red-500 @enderror">
            ...
            <div>
                ...
                <textarea name="subtitle" rows="4" class="w-full px-4 py-2.5 rounded-lg border border-gray-300 text-sm focus:ring-2 focus:border-transparent outline-none transition-all @error('subtitle') border-red-500 @enderror">{{ old('subtitle') }}</textarea>

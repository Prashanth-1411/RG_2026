...
@section('content')
@php $page = \App\Models\Page::where('page_name', 'services')->first(); @endphp
    ...
    <div class="container-premium">
        ...
        <div class="rg-services__grid">
            @forelse($services as $service)
                @include('frontend.components.service-card', ['service' => $service, 'delay' => $loop->index * 100, 'aos' => 'zoom-in-up'])
            @empty

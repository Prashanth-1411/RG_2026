...
<head>
    ...
    <title>Register | R.G. Ambulance Service</title>
    <style>
    ...
    <div class="container right-panel-active" id="container">
        ...
        <div class="form-container sign-in-container">
            <form action="{{ route('login') }}" method="POST">
                ...
                <input type="email" name="email" placeholder="Email Address" required>
                <input type="password" name="password" placeholder="Password" required>
                    <label style="display:flex;align-items:center;width:100%;font-size:14px;color:#2A2A2A;margin-bottom:16px;">
                    <input type="checkbox" name="remember" style="width:auto;height:auto;margin:0 8px 0 0;accent-color:#D4AF37;"> Remember me
                </label>
